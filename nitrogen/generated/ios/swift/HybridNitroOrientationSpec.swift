...
public protocol HybridNitroOrientationSpec_protocol: HybridObject {
  ...
  func getLockOrientation() throws -> String
...
public extension HybridNitroOrientationSpec_protocol {
  ...
  func toString() -> String {
    return "[HybridObject NitroOrientation]"
  }
}
...
open class HybridNitroOrientationSpec_base {
  ...
  public func getCxxWrapper() -> HybridNitroOrientationSpec_cxx {
  #if DEBUG
    guard self is any HybridNitroOrientationSpec else {
    ...
    if let cxxWrapper = self.cxxWrapper {
      ...
      let cxxWrapper = HybridNitroOrientationSpec_cxx(self as! any HybridNitroOrientationSpec)
